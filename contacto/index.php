...
<body>
                    ...
                    <div class="navbar-nav" >
                        ...
                        <!-- <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                                ...
                                <a href="404.html" class="dropdown-item">Electromecanica</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <p class="display-2 text-white mb-4 animated slideInDown">Contactanos</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 300px;">
                <h1 class="display-6 mb-5">Contactanos</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">Necesitas más información, envianos un correo</h3>
                    <form action="../formcontacto.php" method='POST' >
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="mensaje" name="mensaje" style="height: 200px" required></textarea>
                                    <label for="mensaje">Mensaje</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" style="background-color: #00296b;" type="submit">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="container-fluid bg-dark footer mt-5 py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-lg mb-3" style="margin: center;">
