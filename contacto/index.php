...
<body>
    ...
    <!-- Inicio de formulario de cotización -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h2 class="mb-4">Necesitas más información, envianos un correo</h2>
                    <form id="formularioContacto">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="mensaje"
                                        name="mensaje" style="height: 200px" required></textarea>
                                    <label for="mensaje">Mensaje</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5"
                                    style="background-color: #00296b;" type="submit">Enviar</button>
                            </div>
                        </div>
                    </form>
                    <!-- Fin de formulario de cotización -->

                    <!-- Inicio de Modal de confirmación -->
                    <div class="modal fade" id="modalConfirmacion" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center" style="padding: 30px;">
                                    <img src="../img/Logo_E&C_.png" alt="Logo_E&C"
                                        style="width: 95px; height: 45px; margin-bottom: 20px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="margin-bottom: 15px;">
                                        ¡Formulario enviado!
                                    </h5>
                                    <p style="font-size: 1.1rem; color: #333;">Tu formulario ha sido enviado
                                        exitosamente. Nos pondremos
